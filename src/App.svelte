...
import { InstalledCell, AdminWebsocket, AppSignal, AppWebsocket, InstalledAppInfo } from '@holochain/client';

import { appInfoContext } from './contexts';
//import { appWebsocketContext, appInfoContext } from './contexts';
//import { StoredGameState } from './types/dna_0/zome_0';
//*/
...
//const dispatch = createEventDispatcher(); 
 ...
 // const TIMEOUT = 12000
  ...
  const client = await AppWebsocket.connect(`ws://localhost:8000`, 12000, signalCb)

  // default timeout set here (30000) will overwrite the defaultTimeout(12000) set above
  const testVar: String = await client.callZome({
   cap_secret: null,
...
console.log (holMount);
//*/

console.log("after Holochain code");
